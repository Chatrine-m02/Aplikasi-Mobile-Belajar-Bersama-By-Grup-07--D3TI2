package stud11318057.develops.belber.adapters;
...
import stud11318057.develops.belber.views.ScoreView;
...
public class ScoreAdapters extends BaseAdapter
{
    Context mContext;
    List<Score> mScores;
     ...
     */
    public ScoreAdapters(Context context, Map<Integer, Score> scores)
    {
        mContext = context;
